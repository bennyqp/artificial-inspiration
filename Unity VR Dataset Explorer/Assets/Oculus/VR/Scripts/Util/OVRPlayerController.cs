...
public class OVRPlayerController : MonoBehaviour
{
    ...
    /// <summary>
    /// The User kann move up and down by using the SeconderyThumbstick
    /// A cool feature by Benny. 
    /// </summary>
    public bool EnableHeightMovement = true;
    public float heightSpeed = 2;
	...
	public virtual void UpdateMovement()
	{
        ...
        if (EnableHeightMovement == true && OVRInput.Get(OVRInput.Button.SecondaryHandTrigger) == false)
        {
            Vector2 secondaryAxis = OVRInput.Get(OVRInput.Axis2D.SecondaryThumbstick);
            Vector3 currentPos = transform.position;
            currentPos.y += secondaryAxis.y * heightSpeed;
            Debug.Log(currentPos);
            MoveThrottle = currentPos;

        }

		if (EnableRotation && OVRInput.Get(OVRInput.Button.SecondaryHandTrigger))
		{
